...
module RuVim
  class App
    ...
    def register_builtins!
      ...
      register_ex_unless(ex, "r", call: :read_into_buffer, aliases: %w[read], desc: "Read file or command output into buffer", nargs: :any)
      register_ex_unless(ex, "help", call: :show_help, desc: "Show help / topics", nargs: :any)
      register_ex_unless(ex, "command", call: :define_command, desc: "Define user command", nargs: :any, bang: true)
      register_ex_unless(ex, "ruby", call: :eval_ruby, aliases: %w[rb], desc: "Evaluate Ruby", nargs: :any, bang: false)
      ...
      register_ex_unless(ex, "commands", call: :list_commands, desc: "List Ex commands", nargs: 0)
      register_ex_unless(ex, "bindings", call: :list_bindings, desc: "List active key bindings", nargs: :any)
      register_ex_unless(ex, "set", call: :set_option, desc: "Set options", nargs: :any)
      register_ex_unless(ex, "setlocal", call: :set_option_local, desc: "Set window/buffer local option", nargs: :any)
      register_ex_unless(ex, "setglobal", call: :set_option_global, desc: "Set global option", nargs: :any)
      ...
      register_ex_unless(ex, "vimgrep", call: :vimgrep, desc: "Populate quickfix from regex (minimal)", nargs: :any)
      register_ex_unless(ex, "lvimgrep", call: :lvimgrep, desc: "Populate location list from regex (minimal)", nargs: :any)
      register_ex_unless(ex, "copen", call: :quickfix_open, desc: "Open quickfix list", nargs: 0)
      register_ex_unless(ex, "cclose", call: :quickfix_close, desc: "Close quickfix window", nargs: 0)
      register_ex_unless(ex, "cnext", call: :quickfix_next, aliases: %w[cn], desc: "Next quickfix item", nargs: 0)
      register_ex_unless(ex, "cprev", call: :quickfix_prev, aliases: %w[cp], desc: "Prev quickfix item", nargs: 0)
      register_ex_unless(ex, "lopen", call: :loclist_open, desc: "Open location list", nargs: 0)
      register_ex_unless(ex, "lclose", call: :loclist_close, desc: "Close location list window", nargs: 0)
      register_ex_unless(ex, "lnext", call: :loclist_next, aliases: %w[ln], desc: "Next location item", nargs: 0)
      register_ex_unless(ex, "lprev", call: :loclist_prev, aliases: %w[lp], desc: "Prev location item", nargs: 0)
      register_ex_unless(ex, "grep", call: :grep_external, desc: "Search with external grep", nargs: :any)
      register_ex_unless(ex, "lgrep", call: :lgrep_external, desc: "Search with external grep (location list)", nargs: :any)
      register_ex_unless(ex, "d", call: :range_delete, aliases: %w[delete], desc: "Delete lines", nargs: :any)
      register_ex_unless(ex, "y", call: :range_yank, aliases: %w[yank], desc: "Yank lines", nargs: :any)
      register_ex_unless(ex, "p", call: :range_print, aliases: %w[print], desc: "Print lines", nargs: 0)
      register_ex_unless(ex, "nu", call: :range_number, aliases: %w[number], desc: "Print lines with numbers", nargs: 0)
      register_ex_unless(ex, "m", call: :range_move, aliases: %w[move], desc: "Move lines", nargs: :any, raw_args: true)
      register_ex_unless(ex, "t", call: :range_copy, aliases: %w[copy co], desc: "Copy lines", nargs: :any, raw_args: true)
      register_ex_unless(ex, "j", call: :range_join, aliases: %w[join], desc: "Join lines", nargs: 0)
      register_ex_unless(ex, ">", call: :range_shift_right, desc: "Shift lines right", nargs: 0)
      register_ex_unless(ex, "<", call: :range_shift_left, desc: "Shift lines left", nargs: 0)
      register_ex_unless(ex, "normal", call: :execute_normal, aliases: %w[norm], desc: "Execute normal mode commands", nargs: :any, raw_args: true)
      register_ex_unless(ex, "rich", call: :rich_command, desc: "Open/close Rich View", nargs: :maybe_one)
      ...
      register_ex_unless(ex, "filter", call: :filter_lines, desc: "Filter lines matching search pattern", nargs: :any)
      ...
      register_internal_unless(cmd, "quickfix.next", call: :quickfix_next, desc: "Next quickfix item")
      register_internal_unless(cmd, "quickfix.prev", call: :quickfix_prev, desc: "Prev quickfix item")
      register_internal_unless(cmd, "quickfix.open", call: :quickfix_open, desc: "Open quickfix list")

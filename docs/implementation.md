...
17. [設定システム — Ruby DSL による拡張](#17-設定システム--ruby-dsl-による拡張)
18. [テスト戦略 — エディタをどうテストするか](#18-テスト戦略--エディタをどうテストするか)
19. [設計パターンと判断の記録](#19-設計パターンと判断の記録)

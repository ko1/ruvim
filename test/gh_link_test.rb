...
class GhLinkTest < Minitest::Test
  ...
  def test_parse_ssh_remote
    url = RuVim::Commands::Gh.github_url_from_remote("git@github.com:user/repo.git")
    assert_equal "https://github.com/user/repo", url
  end

  def test_parse_ssh_remote_without_dot_git
    url = RuVim::Commands::Gh.github_url_from_remote("git@github.com:user/repo")
    assert_equal "https://github.com/user/repo", url
  end

  def test_parse_https_remote
    url = RuVim::Commands::Gh.github_url_from_remote("https://github.com/user/repo.git")
    assert_equal "https://github.com/user/repo", url
  end

  def test_parse_https_remote_without_dot_git
    url = RuVim::Commands::Gh.github_url_from_remote("https://github.com/user/repo")
    assert_equal "https://github.com/user/repo", url
  end

  def test_parse_non_github_remote_returns_nil
    url = RuVim::Commands::Gh.github_url_from_remote("git@gitlab.com:user/repo.git")
    assert_nil url
  end

  def test_parse_empty_remote_returns_nil
    url = RuVim::Commands::Gh.github_url_from_remote("")
    assert_nil url
  end
  ...
  def test_build_link_single_line
    link = RuVim::Commands::Gh.build_url("https://github.com/user/repo", "main", "lib/foo.rb", 10)
    assert_equal "https://github.com/user/repo/blob/main/lib/foo.rb#L10", link
  end

  def test_build_link_line_range
    link = RuVim::Commands::Gh.build_url("https://github.com/user/repo", "main", "lib/foo.rb", 10, 20)
    assert_equal "https://github.com/user/repo/blob/main/lib/foo.rb#L10-L20", link
  end

  def test_build_link_same_start_end
    link = RuVim::Commands::Gh.build_url("https://github.com/user/repo", "main", "lib/foo.rb", 5, 5)
  ...
  def test_osc52_escape_sequence
    seq = RuVim::Commands::Gh.osc52_copy_sequence("hello")
  ...
  def test_find_github_remote_with_specific_name
    ...
    name, url = RuVim::Commands::Gh.find_github_remote(Dir.pwd, "origin")
    if url
  ...
  def test_find_github_remote_auto_detect
    name, url = RuVim::Commands::Gh.find_github_remote(Dir.pwd)
    if url
  ...
  def test_find_github_remote_nonexistent_returns_nil
    name, url = RuVim::Commands::Gh.find_github_remote(Dir.pwd, "nonexistent_remote_xyz")
    assert_nil name
    assert_nil url
  end
  ...
  def test_resolve_returns_warning_when_file_differs
    ...
    assert RuVim::Commands::Gh.file_differs_from_remote?(Dir.pwd, "nonexistent_remote_xyz", "main", __FILE__)
  end
  ...
  def test_pr_search_url
    url = RuVim::Commands::Gh.pr_search_url("https://github.com/user/repo", "feature-branch")
